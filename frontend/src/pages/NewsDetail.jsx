...
import { FiHeart, FiBookmark, FiEye, FiClock, FiShare2, FiArrowLeft, FiAlertTriangle } from 'react-icons/fi';
          ...
          <div className="flex items-center gap-4 mt-6 py-4 border-y">
            ...
            {isAuthenticated && (
              <button
                ...
                className="flex items-center gap-2 px-4 py-2 ml-auto text-gray-500 hover:text-red-600 transition-colors text-sm"
              >
                <FiAlertTriangle />
                Report Article
              </button>
