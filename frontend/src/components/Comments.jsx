...
import { FiSend, FiEdit2, FiTrash2, FiHeart, FiCornerDownRight, FiFlag } from 'react-icons/fi';
        ...
        <div className="flex items-start gap-3">
          ...
          <div className="flex-1">
            ...
            {editingComment === comment._id ? (
              ...
              <p className="text-gray-400 italic mt-1 bg-gray-50 p-2 rounded border border-gray-100 text-sm">
            ...
            <div className="flex items-center gap-4 mt-2">
              ...
              {user?._id !== comment.user?._id && isAuthenticated && (
                <button
                  onClick={() => setReportingCommentId(comment._id)}
                  className="flex items-center gap-1 text-sm text-gray-400 hover:text-red-500 ml-auto"
